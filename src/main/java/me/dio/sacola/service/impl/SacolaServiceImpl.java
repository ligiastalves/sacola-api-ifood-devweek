...
@Service //dizer ao Spring que essa classe é de serviço
...
public class SacolaServiceImpl implements SacolaService {
    ...
    public Item incluirItemNaSacola(ItemDto itemDto) {
        ...
        if (itensDaSacola.isEmpty()) {
            ...
            if (restauranteAtual.equals(restauranteDoItemParaAdd)) {
                ...
                throw new RuntimeException("Não é possivel adicionar produtos de restaurante diferente. Feche a sacola ou esvazie");
            }
        }
    ...
    public Sacola fecharSacola(Long id, int numeroformaPagamento) {
        ...
        //ve se a sacola esta vazia, busca pelo Id, caso esteja errado, entra na exception
